...
func (p *StateProcessor) Process(block *types.Block, statedb *state.StateDB, cfg vm.Config, crosschain vm.CrossChainContract) (types.Receipts, []*types.Log, uint64, error) {
	var (
...
func ApplyTransaction(config *params.ChainConfig, bc ChainContext, author *common.Address, gp *GasPool, statedb *state.StateDB, header *types.Header, tx *types.Transaction, usedGas *uint64, cfg vm.Config, crosschain vm.CrossChainContract) (*types.Receipt, error) {
