...
var (
	...
	TestnetGenesisHash = common.HexToHash("0xa9458e9e348f5de596918083b203042cbe58f27d222189cd7aae577c9f8be954")
)
...
var (
	...
	AllChaosProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, &ChaosConfig{Period: 0, Epoch: 30000, AttestationDelay: 2}}
